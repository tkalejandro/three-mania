    ...
    projects: [
        {
            ...
            explanation: "Oversaw full scope of music production effort through the development pipeline including project initialization, tools configuration, design documentation and production planning.",
            city: "Los Angeles",
            country: "USA",
            online: false,
            ...
            highlights: [
                ...
                "Collaborated directly with game director and audio director to fulfill the directors’ vision for the music and provided departmental guidance to sustain creative consistency through release.",
        ...
        },
        {
            ...
            explanation: "Authored music assets from composer deliveries into interactive music and linear content for in-game use, as well as marketing material leading up to release using Pro Tools.",
            city: "Los Angeles",
            country: "USA",
            online: false,
    ...
    experience: [
        {
            ...
            explanation: "Organized and maintained concurrent relationships with external partners across PlayStation Studios to document, produce, and deliver music requests.",
            city: "Los Angeles",
            country: "USA",
            online: false,
